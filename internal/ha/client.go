// Package ha talks to Home Assistant over its REST API for sensor states,
// weather forecasts, and actuator service calls.
package ha
...
// CallService invokes a service, for example switch/turn_on.
