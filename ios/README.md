...
- **Plants** opens the searchable library and each plant's story, including bounded fan control with shared airflow records, on-demand photo analysis, before-and-after care follow-ups, resumable chat history, photo overlays, and printable QR labels.
