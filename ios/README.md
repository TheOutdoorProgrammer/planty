...
- **Plants** opens the searchable library and each plant's story, including bounded fan control with shared airflow records, one screen for fan and grow-light schedules with multiple daily windows, on-demand photo analysis, before-and-after care follow-ups, chat replies that continue after the app closes, photo overlays, and printable QR labels.
